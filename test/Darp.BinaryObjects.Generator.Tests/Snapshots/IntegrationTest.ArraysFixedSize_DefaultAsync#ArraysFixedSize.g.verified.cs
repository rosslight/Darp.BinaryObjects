...
/// </list> </remarks>
public partial record ArraysFixedSize : global::Darp.BinaryObjects.IWritable, global::Darp.BinaryObjects.ISpanReadable<ArraysFixedSize>
{
    /// <inheritdoc />
    ...
    /// <inheritdoc />
    public static bool TryReadLittleEndian(global::System.ReadOnlySpan<byte> source, [NotNullWhen(true)] out ArraysFixedSize? value) => TryReadLittleEndian(source, out value, out _);
    /// <inheritdoc />
    public static bool TryReadLittleEndian(global::System.ReadOnlySpan<byte> source, [NotNullWhen(true)] out ArraysFixedSize? value, out int bytesRead)
    {
        bytesRead = 0;
        value = default;
        ...
        if (source.Length < 24)
            return false;
        var ___readValueByteMemory = BinaryHelpers.ReadUInt8Array(source[0..2]);
        var ___readValueByteArray = BinaryHelpers.ReadUInt8Array(source[2..4]);
        var ___readValueByteList = BinaryHelpers.ReadUInt8List(source[4..6]);
        var ___readValueByteEnumerable = BinaryHelpers.ReadUInt8Array(source[6..8]);
        var ___readValueUShortMemory = BinaryHelpers.ReadUInt16ArrayLittleEndian(source[8..12]);
        var ___readValueUShortArray = BinaryHelpers.ReadUInt16ArrayLittleEndian(source[12..16]);
        var ___readValueUShortList = BinaryHelpers.ReadUInt16ListLittleEndian(source[16..20]);
        var ___readValueUShortEnumerable = BinaryHelpers.ReadUInt16ArrayLittleEndian(source[20..24]);
        bytesRead += 24;
    ...
    /// <inheritdoc />
    public static bool TryReadBigEndian(global::System.ReadOnlySpan<byte> source, [NotNullWhen(true)] out ArraysFixedSize? value) => TryReadBigEndian(source, out value, out _);
    /// <inheritdoc />
    public static bool TryReadBigEndian(global::System.ReadOnlySpan<byte> source, [NotNullWhen(true)] out ArraysFixedSize? value, out int bytesRead)
    {
        bytesRead = 0;
        value = default;
        ...
        var ___readValueByteList = BinaryHelpers.ReadUInt8List(source[4..6]);
        var ___readValueByteEnumerable = BinaryHelpers.ReadUInt8Array(source[6..8]);
        var ___readValueUShortMemory = BinaryHelpers.ReadUInt16ArrayBigEndian(source[8..12]);
        var ___readValueUShortArray = BinaryHelpers.ReadUInt16ArrayBigEndian(source[12..16]);
        var ___readValueUShortList = BinaryHelpers.ReadUInt16ListBigEndian(source[16..20]);
        var ___readValueUShortEnumerable = BinaryHelpers.ReadUInt16ArrayBigEndian(source[20..24]);
        bytesRead += 24;
